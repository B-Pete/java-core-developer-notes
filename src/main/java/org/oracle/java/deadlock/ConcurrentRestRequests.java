...
/**
 * @author https://github.com/josephmate/JavaDeadlocks
 */
public class ConcurrentRestRequests {
	...
	private static class DeadlockRunnable implements Runnable {
		...
		public DeadlockRunnable(CyclicBarrier ensureBothThreadsGrabTheirLock, Lock lockToGrabFirst,
